  ...
  return (
    <div className="h-screen flex justify-between flex-col">
      <aside className="flex ">
        <div className="flex shadow-xl  flex-col items-center lg:w-20 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="grid lg:grid-cols-12 gap-5 w-full py-5 lg:mx-5">
          <div className="col-span-3 shadow-xl rounded-lg bg-blue-400/90 text-black p-5">
            <ul>
              <li>lorem</li>
              <li>lorem</li>
              <li>lorem</li>
          ...
          <div className="col-span-6 shadow-xl rounded-lg p-5 relative">
            <h1 className="text-5xl text-center font-bold from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r bg-clip-text text-transparent mt-10">
              Welcome to LawGuru
            </h1>
          ...
          <div className="col-span-3 shadow-xl rounded-lg p-5"></div>
        </div>
